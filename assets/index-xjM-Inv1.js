...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Cn,depthTest:!1,depthWrite:!1})}function Ym(n,e,t){const i=new Float32Array(li),r=new G(0,1,0);return new yn({name:"SphericalGaussianBlur",defines:{n:li,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Fs(),fragmentShader:`
...
`)}const Jg={[Kl]:"Linear",[jl]:"Reinhard",[Zl]:"Cineon",[Jl]:"ACESFilmic",[eu]:"AgX",[tu]:"Neutral",[Ql]:"Custom"};function Qg(n,e){const t=Jg[e];return t===void 0?(Be("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ps=new G;function e0(){Ze.getLuminanceCoefficients(ps);const n=ps.x.toFixed(4),e=ps.y.toFixed(4),t=ps.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
