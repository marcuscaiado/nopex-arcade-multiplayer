...
void main() {
	...
	`}function $m(n){let e=new WeakMap,t=null;function i(o){if(o&&o.isTexture){const c=o.mapping,l=c===$a||c===Ka,h=c===mi||c===qi;if(l||h){let u=e.get(o);const f=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new Jc(n)),u=l?t.fromEquirectangular(o,u):t.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),u.texture;if(u!==void 0)return u.texture;{const p=o.image;return l&&p&&p.height>0||h&&p&&r(p)?(t===null&&(t=new Jc(n)),u=l?t.fromEquirectangular(o):t.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),o.addEventListener("dispose",s),u.texture):null}}}return o}function r(o){let c=0;const l=6;for(let h=0;h<l;h++)o[h]!==void 0&&c++;return c===l}function s(o){const c=o.target;c.removeEventListener("dispose",s);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:a}}function Km(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const r=n.getExtension(i);return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&Cr("WebGLRenderer: "+i+" extension not supported."),r}}}function jm(n,e,t,i){const r={},s=new WeakMap;function a(u){const f=u.target;f.index!==null&&e.remove(f.index);for(const g in f.attributes)e.remove(f.attributes[g]);f.removeEventListener("dispose",a),delete r[f.id];const p=s.get(f);p&&(e.remove(p),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(u,f){return r[f.id]===!0||(f.addEventListener("dispose",a),r[f.id]=!0,t.memory.geometries++),f}function c(u){const f=u.attributes;for(const p in f)e.update(f[p],n.ARRAY_BUFFER)}function l(u){const f=[],p=u.index,g=u.attributes.position;let _=0;if(p!==null){const v=p.array;_=p.version;for(let E=0,b=v.length;E<b;E+=3){const S=v[E+0],w=v[E+1],C=v[E+2];f.push(S,w,w,C,C,S)}}else if(g!==void 0){const v=g.array;_=g.version;for(let E=0,b=v.length/3-1;E<b;E+=3){const S=E+0,w=E+1,C=E+2;f.push(S,w,w,C,C,S)}}else return;const m=new(fu(f)?gu:mu)(f,1);m.version=_;const d=s.get(u);d&&e.remove(d),s.set(u,m)}function h(u){const f=s.get(u);if(f){const p=u.index;p!==null&&f.version<p.version&&l(u)}else l(u);return s.get(u)}return{get:o,update:c,getWireframeAttribute:h}}function Zm(n,e,t){let i;function r(f){i=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function c(f,p){n.drawElements(i,p,s,f*a),t.update(p,i,1)}function l(f,p,g){g!==0&&(n.drawElementsInstanced(i,p,s,f*a,g),t.update(p,i,g))}function h(f,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,p,0,s,f,0,g);let m=0;for(let d=0;d<g;d++)m+=p[d];t.update(m,i,1)}function u(f,p,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)l(f[d]/a,p[d],_[d]);else{m.multiDrawElementsInstancedWEBGL(i,p,0,s,f,0,_,0,g);let d=0;for(let v=0;v<g;v++)d+=p[v]*_[v];t.update(d,i,1)}}this.setMode=r,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Jm(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(s/3);break;case n.LINES:t.lines+=o*(s/2);break;case n.LINE_STRIP:t.lines+=o*(s-1);break;case n.LINE_LOOP:t.lines+=o*s;break;case n.POINTS:t.points+=o*s;break;default:je("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function Qm(n,e,t){const i=new WeakMap,r=new gt;function s(a,o,c){const l=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let f=i.get(o);if(f===void 0||f.count!==u){let y=function(){C.dispose(),i.delete(o),o.removeEventListener("dispose",y)};f!==void 0&&f.texture.dispose();const p=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,_=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],d=o.morphAttributes.normal||[],v=o.morphAttributes.color||[];let E=0;p===!0&&(E=1),g===!0&&(E=2),_===!0&&(E=3);let b=o.attributes.position.count*E,S=1;b>e.maxTextureSize&&(S=Math.ceil(b/e.maxTextureSize),b=e.maxTextureSize);const w=new Float32Array(b*S*4*u),C=new hu(w,b,S,u);C.type=dn,C.needsUpdate=!0;const P=E*4;for(let T=0;T<u;T++){const I=m[T],z=d[T],k=v[T],A=b*S*4*T;for(let D=0;D<I.count;D++){const U=D*P;p===!0&&(r.fromBufferAttribute(I,D),w[A+U+0]=r.x,w[A+U+1]=r.y,w[A+U+2]=r.z,w[A+U+3]=0),g===!0&&(r.fromBufferAttribute(z,D),w[A+U+4]=r.x,w[A+U+5]=r.y,w[A+U+6]=r.z,w[A+U+7]=0),_===!0&&(r.fromBufferAttribute(k,D),w[A+U+8]=r.x,w[A+U+9]=r.y,w[A+U+10]=r.z,w[A+U+11]=k.itemSize===4?r.w:1)}}f={count:u,texture:C,size:new Ve(b,S)},i.set(o,f),o.addEventListener("dispose",y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let p=0;for(let _=0;_<l.length;_++)p+=l[_];const g=o.morphTargetsRelative?1:1-p;c.getUniforms().setValue(n,"morphTargetBaseInfluence",g),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",f.texture,t),c.getUniforms().setValue(n,"morphTargetsTextureSize",f.size)}return{update:s}}function eg(n,e,t,i){let r=new WeakMap;function s(c){const l=i.render.frame,h=c.geometry,u=e.get(c,h);if(r.get(u)!==l&&(e.update(u),r.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),r.get(c)!==l&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==l&&(f.update(),r.set(f,l))}return u}function a(){r=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:a}}const tg={[Kl]:"LINEAR_TONE_MAPPING",[jl]:"REINHARD_TONE_MAPPING",[Zl]:"CINEON_TONE_MAPPING",[Jl]:"ACES_FILMIC_TONE_MAPPING",[eu]:"AGX_TONE_MAPPING",[tu]:"NEUTRAL_TONE_MAPPING",[Ql]:"CUSTOM_TONE_MAPPING"};function ng(n,e,t,i,r){const s=new gn(e,t,{type:n,depthBuffer:i,stencilBuffer:r}),a=new gn(e,t,{type:Un,depthBuffer:!1,stencilBuffer:!1}),o=new kt;o.setAttribute("position",new _t([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new _t([0,2,0,0,2,0],2));const c=new Xh({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
void main() {
    ...
    `,t.appendChild(i),document.body.appendChild(t),this.modalEl=t;const r=i.querySelector("#mp-tag-input");r.addEventListener("input",o=>{r.value=r.value.replace(/[^a-zA-Z0-9]/g,"").slice(0,5).toUpperCase()});const s=i.querySelectorAll(".color-swatch");s.forEach(o=>{o.addEventListener("click",()=>{this.colorHex=o.getAttribute("data-hex"),s.forEach(c=>{const l=c.getAttribute("data-hex")===this.colorHex;c.style.border=l?"3px solid #fff":"transparent",c.style.boxShadow=l?"0 0 12px "+this.colorHex:"none"})})}),i.querySelector("#mp-enter-btn").addEventListener("click",()=>{const o=r.value.trim().toUpperCase();if(!o||o.length<2){alert("Por favor, digite uma TAG de 2 a 5 letras!"),r.focus();return}this.tag=o,localStorage.setItem("ARCADE_MP_TAG",this.tag),localStorage.setItem("ARCADE_MP_COLOR",this.colorHex),this.hideModal(),this.onReady&&this.onReady(this.getIdentity())})}showModal(){this.modalEl&&(this.modalEl.style.display="flex")}hideModal(){this.modalEl&&(this.modalEl.style.display="none")}}const yv="https://gist.githubusercontent.com/marcuscaiado/a238a8db5b064579413c7a54aba6c840/raw/marcus-arcade-leaderboard.json";function Yl(){const n=document.getElementById("arcade-3d-canvas-container"),e=document.getElementById("webgl-error");if(!n){console.error("Missing #arcade-3d-canvas-container");return}let t=null;const i=new vv(u=>{if(t)t.setPlayerIdentity(u);else try{t=new xv(n,Xr,u),t.start()}catch(f){console.error("Fatal WebGL / Three.js Initialization Error:",f),e&&(e.style.display="block",e.textContent="Erro ao inicializar 3D: "+f.message)}}),r=document.getElementById("arcade-tag-btn");if(r&&r.addEventListener("click",u=>{u.stopPropagation(),i.showModal()}),window.ArcadeLeaderboard&&window.ArcadeLeaderboard.submitScore){const u=window.ArcadeLeaderboard.submitScore.bind(window.ArcadeLeaderboard);window.ArcadeLeaderboard.submitScore=function(f,p){const g=u(f,p);if(window.__ARCADE_NETWORK__){const _=Xr.find(d=>d.id===f),m=_?_.title:f;window.__ARCADE_NETWORK__.broadcastHighScore(m,p)}return g}}window.addEventListener("message",u=>{if(u.data&&(u.data.type==="ARCADE_SCORE"||u.data.type==="GAME_SCORE")&&u.data.score&&window.__ARCADE_NETWORK__){const f=Xr.find(g=>g.id===u.data.gameId),p=f&&f.title||u.data.gameTitle||"Arcade Game";window.__ARCADE_NETWORK__.broadcastHighScore(p,Number(u.data.score))}});const s=document.getElementById("teleport-select");s&&s.addEventListener("change",u=>{const f=u.target.value;f&&t&&(If(()=>Promise.resolve().then(()=>J0),void 0,import.meta.url).then(p=>p.playDopamineChime()),t.teleportToCabinet(f),s.blur())});const a=document.getElementById("arcade-ctrl-toggle"),o=document.getElementById("arcade-joystick"),c=document.getElementById("arcade-dpad");let l="joystick";a&&o&&c&&a.addEventListener("click",u=>{u.stopPropagation(),l==="joystick"?(l="dpad",o.style.display="none",c.style.display="flex",a.innerHTML="<span>🕹️ JOYSTICK</span>"):(l="joystick",o.style.display="block",c.style.display="none",a.innerHTML="<span>🎮 D-PAD</span>")});async function h(){window.__ARCADE_LEADERBOARDS__=window.__ARCADE_LEADERBOARDS__||{};try{const u=await fetch(`${yv}?_t=${Date.now()}`);if(u.ok){const f=await u.json();Xr.forEach(p=>{let g=[];try{g=JSON.parse(localStorage.getItem(`arcade_lb_${p.id}`)||"[]")}catch{}const m=[...f[p.id]||[],...g].filter(v=>v&&v.name&&v.score);m.sort((v,E)=>E.score-v.score);const d=m[0];d&&(window.__ARCADE_LEADERBOARDS__[p.id]={topScore:d.score,topPilot:String(d.name).replace(/[^a-zA-Z0-9]/g,"").toUpperCase().substring(0,3)||"MRC"})})}}catch(u){console.warn("Could not sync cloud records:",u)}}h()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Yl):Yl();
