...
`)}const c_={[hd]:"Linear",[dd]:"Reinhard",[ud]:"Cineon",[fd]:"ACESFilmic",[md]:"AgX",[gd]:"Neutral",[pd]:"Custom"};function h_(n,e){const t=c_[e];return t===void 0?(je("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Rr=new q;function d_(){lt.getLuminanceCoefficients(Rr);const n=Rr.x.toFixed(4),e=Rr.y.toFixed(4),t=Rr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);const R=T+m+a,S=T+p+o,x=ih(s,s.VERTEX_SHADER,R),E=ih(s,s.FRAGMENT_SHADER,S);s.attachShader(_,x),s.attachShader(_,E),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function L(B){if(n.debug.checkShaderErrors){const D=s.getProgramInfoLog(_)||"",C=s.getShaderInfoLog(x)||"",I=s.getShaderInfoLog(E)||"",N=D.trim(),F=C.trim(),U=I.trim();let z=!0,K=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(z=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,_,x,E);else{const $=rh(s,x,"vertex"),W=rh(s,E,"fragment");ot("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
}`,X_=[new q(1,0,0),new q(-1,0,0),new q(0,1,0),new q(0,-1,0),new q(0,0,1),new q(0,0,-1)],q_=[new q(0,-1,0),new q(0,-1,0),new q(0,0,1),new q(0,0,-1),new q(0,-1,0),new q(0,-1,0)],fh=new Et,Ds=new q,io=new q;function Y_(n,e,t){let i=new Ql;const s=new Je,r=new Je,a=new Tt,o=new ip,l=new sp,c={},h=t.maxTextureSize,d={[Gn]:qt,[qt]:Gn,[Ut]:Ut},u=new An({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Je},radius:{value:4}},vertexShader:H_,fragmentShader:W_}),f=u.clone();f.defines.HORIZONTAL_PASS=1;const g=new Ht;g.setAttribute("position",new un(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Ce(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=kr;let p=this.type;this.render=function(E,L,O){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||E.length===0)return;E.type===Xu&&(je("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),E.type=kr);const y=n.getRenderTarget(),b=n.getActiveCubeFace(),B=n.getActiveMipmapLevel(),D=n.state;D.setBlending(Bn),D.buffers.depth.getReversed()===!0?D.buffers.color.setClear(0,0,0,0):D.buffers.color.setClear(1,1,1,1),D.buffers.depth.setTest(!0),D.setScissorTest(!1);const C=p!==this.type;C&&L.traverse(function(I){I.material&&(Array.isArray(I.material)?I.material.forEach(N=>N.needsUpdate=!0):I.material.needsUpdate=!0)});for(let I=0,N=E.length;I<N;I++){const F=E[I],U=F.shadow;if(U===void 0){je("WebGLShadowMap:",F,"has no shadow.");continue}if(U.autoUpdate===!1&&U.needsUpdate===!1)continue;s.copy(U.mapSize);const z=U.getFrameExtents();if(s.multiply(z),r.copy(U.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/z.x),s.x=r.x*z.x,U.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/z.y),s.y=r.y*z.y,U.mapSize.y=r.y)),U.map===null||C===!0){if(U.map!==null&&(U.map.depthTexture!==null&&(U.map.depthTexture.dispose(),U.map.depthTexture=null),U.map.dispose()),this.type===Us){if(F.isPointLight){je("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}U.map=new Mn(s.x,s.y,{format:ls,type:Hn,minFilter:St,magFilter:St,generateMipmaps:!1}),U.map.texture.name=F.name+".shadowMap",U.map.depthTexture=new Xs(s.x,s.y,Sn),U.map.depthTexture.name=F.name+".shadowMapDepth",U.map.depthTexture.format=Wn,U.map.depthTexture.compareFunction=null,U.map.depthTexture.minFilter=At,U.map.depthTexture.magFilter=At}else{F.isPointLight?(U.map=new Ud(s.x),U.map.depthTexture=new tp(s.x,wn)):(U.map=new Mn(s.x,s.y),U.map.depthTexture=new Xs(s.x,s.y,wn)),U.map.depthTexture.name=F.name+".shadowMap",U.map.depthTexture.format=Wn;const $=n.state.buffers.depth.getReversed();this.type===kr?(U.map.depthTexture.compareFunction=$?jl:Yl,U.map.depthTexture.minFilter=St,U.map.depthTexture.magFilter=St):(U.map.depthTexture.compareFunction=null,U.map.depthTexture.minFilter=At,U.map.depthTexture.magFilter=At)}U.camera.updateProjectionMatrix()}const K=U.map.isWebGLCubeRenderTarget?6:1;for(let $=0;$<K;$++){if(U.map.isWebGLCubeRenderTarget)n.setRenderTarget(U.map,$),n.clear();else{$===0&&(n.setRenderTarget(U.map),n.clear());const W=U.getViewport($);a.set(r.x*W.x,r.y*W.y,r.x*W.z,r.y*W.w),D.viewport(a)}if(F.isPointLight){const W=U.camera,ee=U.matrix,fe=F.distance||W.far;fe!==W.far&&(W.far=fe,W.updateProjectionMatrix()),Ds.setFromMatrixPosition(F.matrixWorld),W.position.copy(Ds),io.copy(W.position),io.add(X_[$]),W.up.copy(q_[$]),W.lookAt(io),W.updateMatrixWorld(),ee.makeTranslation(-Ds.x,-Ds.y,-Ds.z),fh.multiplyMatrices(W.projectionMatrix,W.matrixWorldInverse),U._frustum.setFromProjectionMatrix(fh,W.coordinateSystem,W.reversedDepth)}else U.updateMatrices(F);i=U.getFrustum(),S(L,O,U.camera,F,this.type)}U.isPointLightShadow!==!0&&this.type===Us&&T(U,O),U.needsUpdate=!1}p=this.type,m.needsUpdate=!1,n.setRenderTarget(y,b,B)};function T(E,L){const O=e.update(_);u.defines.VSM_SAMPLES!==E.blurSamples&&(u.defines.VSM_SAMPLES=E.blurSamples,f.defines.VSM_SAMPLES=E.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new Mn(s.x,s.y,{format:ls,type:Hn})),u.uniforms.shadow_pass.value=E.map.depthTexture,u.uniforms.resolution.value=E.mapSize,u.uniforms.radius.value=E.radius,n.setRenderTarget(E.mapPass),n.clear(),n.renderBufferDirect(L,null,O,u,_,null),f.uniforms.shadow_pass.value=E.mapPass.texture,f.uniforms.resolution.value=E.mapSize,f.uniforms.radius.value=E.radius,n.setRenderTarget(E.map),n.clear(),n.renderBufferDirect(L,null,O,f,_,null)}function R(E,L,O,y){let b=null;const B=O.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(B!==void 0)b=B;else if(b=O.isPointLight===!0?l:o,n.localClippingEnabled&&L.clipShadows===!0&&Array.isArray(L.clippingPlanes)&&L.clippingPlanes.length!==0||L.displacementMap&&L.displacementScale!==0||L.alphaMap&&L.alphaTest>0||L.map&&L.alphaTest>0||L.alphaToCoverage===!0){const D=b.uuid,C=L.uuid;let I=c[D];I===void 0&&(I={},c[D]=I);let N=I[C];N===void 0&&(N=b.clone(),I[C]=N,L.addEventListener("dispose",x)),b=N}if(b.visible=L.visible,b.wireframe=L.wireframe,y===Us?b.side=L.shadowSide!==null?L.shadowSide:L.side:b.side=L.shadowSide!==null?L.shadowSide:d[L.side],b.alphaMap=L.alphaMap,b.alphaTest=L.alphaToCoverage===!0?.5:L.alphaTest,b.map=L.map,b.clipShadows=L.clipShadows,b.clippingPlanes=L.clippingPlanes,b.clipIntersection=L.clipIntersection,b.displacementMap=L.displacementMap,b.displacementScale=L.displacementScale,b.displacementBias=L.displacementBias,b.wireframeLinewidth=L.wireframeLinewidth,b.linewidth=L.linewidth,O.isPointLight===!0&&b.isMeshDistanceMaterial===!0){const D=n.properties.get(b);D.light=O}return b}function S(E,L,O,y,b){if(E.visible===!1)return;if(E.layers.test(L.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&b===Us)&&(!E.frustumCulled||i.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,E.matrixWorld);const C=e.update(E),I=E.material;if(Array.isArray(I)){const N=C.groups;for(let F=0,U=N.length;F<U;F++){const z=N[F],K=I[z.materialIndex];if(K&&K.visible){const $=R(E,K,y,b);E.onBeforeShadow(n,E,L,O,C,$,z),n.renderBufferDirect(O,null,C,$,E,z),E.onAfterShadow(n,E,L,O,C,$,z)}}}else if(I.visible){const N=R(E,I,y,b);E.onBeforeShadow(n,E,L,O,C,N,null),n.renderBufferDirect(O,null,C,N,E,null),E.onAfterShadow(n,E,L,O,C,N,null)}}const D=E.children;for(let C=0,I=D.length;C<I;C++)S(D[C],L,O,y,b)}function x(E){E.target.removeEventListener("dispose",x);for(const O in c){const y=c[O],b=E.target.uuid;b in y&&(y[b].dispose(),delete y[b])}}}const j_={[Uo]:Fo,[Oo]:zo,[ko]:Vo,[as]:Bo,[Fo]:Uo,[zo]:Oo,[Vo]:ko,[Bo]:as};function $_(n,e){function t(){let V=!1;const Re=new Tt;let ve=null;const Le=new Tt(0,0,0,0);return{setMask:function(ge){ve!==ge&&!V&&(n.colorMask(ge,ge,ge,ge),ve=ge)},setLocked:function(ge){V=ge},setClear:function(ge,he,Ee,Ye,_t){_t===!0&&(ge*=Ye,he*=Ye,Ee*=Ye),Re.set(ge,he,Ee,Ye),Le.equals(Re)===!1&&(n.clearColor(ge,he,Ee,Ye),Le.copy(Re))},reset:function(){V=!1,ve=null,Le.set(-1,0,0,0)}}}function i(){let V=!1,Re=!1,ve=null,Le=null,ge=null;return{setReversed:function(he){if(Re!==he){const Ee=e.get("EXT_clip_control");he?Ee.clipControlEXT(Ee.LOWER_LEFT_EXT,Ee.ZERO_TO_ONE_EXT):Ee.clipControlEXT(Ee.LOWER_LEFT_EXT,Ee.NEGATIVE_ONE_TO_ONE_EXT),Re=he;const Ye=ge;ge=null,this.setClear(Ye)}},getReversed:function(){return Re},setTest:function(he){he?Z(n.DEPTH_TEST):re(n.DEPTH_TEST)},setMask:function(he){ve!==he&&!V&&(n.depthMask(he),ve=he)},setFunc:function(he){if(Re&&(he=j_[he]),Le!==he){switch(he){case Uo:n.depthFunc(n.NEVER);break;case Fo:n.depthFunc(n.ALWAYS);break;case Oo:n.depthFunc(n.LESS);break;case as:n.depthFunc(n.LEQUAL);break;case ko:n.depthFunc(n.EQUAL);break;case Bo:n.depthFunc(n.GEQUAL);break;case zo:n.depthFunc(n.GREATER);break;case Vo:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Le=he}},setLocked:function(he){V=he},setClear:function(he){ge!==he&&(Re&&(he=1-he),n.clearDepth(he),ge=he)},reset:function(){V=!1,ve=null,Le=null,ge=null,Re=!1}}}function s(){let V=!1,Re=null,ve=null,Le=null,ge=null,he=null,Ee=null,Ye=null,_t=null;return{setTest:function(ct){V||(ct?Z(n.STENCIL_TEST):re(n.STENCIL_TEST))},setMask:function(ct){Re!==ct&&!V&&(n.stencilMask(ct),Re=ct)},setFunc:function(ct,Jt,ln){(ve!==ct||Le!==Jt||ge!==ln)&&(n.stencilFunc(ct,Jt,ln),ve=ct,Le=Jt,ge=ln)},setOp:function(ct,Jt,ln){(he!==ct||Ee!==Jt||Ye!==ln)&&(n.stencilOp(ct,Jt,ln),he=ct,Ee=Jt,Ye=ln)},setLocked:function(ct){V=ct},setClear:function(ct){_t!==ct&&(n.clearStencil(ct),_t=ct)},reset:function(){V=!1,Re=null,ve=null,Le=null,ge=null,he=null,Ee=null,Ye=null,_t=null}}}const r=new t,a=new i,o=new s,l=new WeakMap,c=new WeakMap;let h={},d={},u=new WeakMap,f=[],g=null,_=!1,m=null,p=null,T=null,R=null,S=null,x=null,E=null,L=new at(0,0,0),O=0,y=!1,b=null,B=null,D=null,C=null,I=null;const N=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let F=!1,U=0;const z=n.getParameter(n.VERSION);z.indexOf("WebGL")!==-1?(U=parseFloat(/^WebGL (\d)/.exec(z)[1]),F=U>=1):z.indexOf("OpenGL ES")!==-1&&(U=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),F=U>=2);let K=null,$={};const W=n.getParameter(n.SCISSOR_BOX),ee=n.getParameter(n.VIEWPORT),fe=new Tt().fromArray(W),_e=new Tt().fromArray(ee);function ye(V,Re,ve,Le){const ge=new Uint8Array(4),he=n.createTexture();n.bindTexture(V,he),n.texParameteri(V,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(V,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ee=0;Ee<ve;Ee++)V===n.TEXTURE_3D||V===n.TEXTURE_2D_ARRAY?n.texImage3D(Re,0,n.RGBA,1,1,Le,0,n.RGBA,n.UNSIGNED_BYTE,ge):n.texImage2D(Re+Ee,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,ge);return he}const X={};X[n.TEXTURE_2D]=ye(n.TEXTURE_2D,n.TEXTURE_2D,1),X[n.TEXTURE_CUBE_MAP]=ye(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),X[n.TEXTURE_2D_ARRAY]=ye(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),X[n.TEXTURE_3D]=ye(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),Z(n.DEPTH_TEST),a.setFunc(as),He(!1),k(pc),Z(n.CULL_FACE),ke(Bn);function Z(V){h[V]!==!0&&(n.enable(V),h[V]=!0)}function re(V){h[V]!==!1&&(n.disable(V),h[V]=!1)}function ue(V,Re){return d[V]!==Re?(n.bindFramebuffer(V,Re),d[V]=Re,V===n.DRAW_FRAMEBUFFER&&(d[n.FRAMEBUFFER]=Re),V===n.FRAMEBUFFER&&(d[n.DRAW_FRAMEBUFFER]=Re),!0):!1}function se(V,Re){let ve=f,Le=!1;if(V){ve=u.get(Re),ve===void 0&&(ve=[],u.set(Re,ve));const ge=V.textures;if(ve.length!==ge.length||ve[0]!==n.COLOR_ATTACHMENT0){for(let he=0,Ee=ge.length;he<Ee;he++)ve[he]=n.COLOR_ATTACHMENT0+he;ve.length=ge.length,Le=!0}}else ve[0]!==n.BACK&&(ve[0]=n.BACK,Le=!0);Le&&n.drawBuffers(ve)}function Te(V){return g!==V?(n.useProgram(V),g=V,!0):!1}const Ge={[_i]:n.FUNC_ADD,[Yu]:n.FUNC_SUBTRACT,[ju]:n.FUNC_REVERSE_SUBTRACT};Ge[$u]=n.MIN,Ge[Ku]=n.MAX;const Pe={[Zu]:n.ZERO,[Ju]:n.ONE,[Qu]:n.SRC_COLOR,[Do]:n.SRC_ALPHA,[af]:n.SRC_ALPHA_SATURATE,[sf]:n.DST_COLOR,[tf]:n.DST_ALPHA,[ef]:n.ONE_MINUS_SRC_COLOR,[No]:n.ONE_MINUS_SRC_ALPHA,[rf]:n.ONE_MINUS_DST_COLOR,[nf]:n.ONE_MINUS_DST_ALPHA,[of]:n.CONSTANT_COLOR,[lf]:n.ONE_MINUS_CONSTANT_COLOR,[cf]:n.CONSTANT_ALPHA,[hf]:n.ONE_MINUS_CONSTANT_ALPHA};function ke(V,Re,ve,Le,ge,he,Ee,Ye,_t,ct){if(V===Bn){_===!0&&(re(n.BLEND),_=!1);return}if(_===!1&&(Z(n.BLEND),_=!0),V!==qu){if(V!==m||ct!==y){if((p!==_i||S!==_i)&&(n.blendEquation(n.FUNC_ADD),p=_i,S=_i),ct)switch(V){case ns:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case mc:n.blendFunc(n.ONE,n.ONE);break;case gc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case _c:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:ot("WebGLState: Invalid blending: ",V);break}else switch(V){case ns:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case mc:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case gc:ot("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case _c:ot("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ot("WebGLState: Invalid blending: ",V);break}T=null,R=null,x=null,E=null,L.set(0,0,0),O=0,m=V,y=ct}return}ge=ge||Re,he=he||ve,Ee=Ee||Le,(Re!==p||ge!==S)&&(n.blendEquationSeparate(Ge[Re],Ge[ge]),p=Re,S=ge),(ve!==T||Le!==R||he!==x||Ee!==E)&&(n.blendFuncSeparate(Pe[ve],Pe[Le],Pe[he],Pe[Ee]),T=ve,R=Le,x=he,E=Ee),(Ye.equals(L)===!1||_t!==O)&&(n.blendColor(Ye.r,Ye.g,Ye.b,_t),L.copy(Ye),O=_t),m=V,y=!1}function Ke(V,Re){V.side===Ut?re(n.CULL_FACE):Z(n.CULL_FACE);let ve=V.side===qt;Re&&(ve=!ve),He(ve),V.blending===ns&&V.transparent===!1?ke(Bn):ke(V.blending,V.blendEquation,V.blendSrc,V.blendDst,V.blendEquationAlpha,V.blendSrcAlpha,V.blendDstAlpha,V.blendColor,V.blendAlpha,V.premultipliedAlpha),a.setFunc(V.depthFunc),a.setTest(V.depthTest),a.setMask(V.depthWrite),r.setMask(V.colorWrite);const Le=V.stencilWrite;o.setTest(Le),Le&&(o.setMask(V.stencilWriteMask),o.setFunc(V.stencilFunc,V.stencilRef,V.stencilFuncMask),o.setOp(V.stencilFail,V.stencilZFail,V.stencilZPass)),Y(V.polygonOffset,V.polygonOffsetFactor,V.polygonOffsetUnits),V.alphaToCoverage===!0?Z(n.SAMPLE_ALPHA_TO_COVERAGE):re(n.SAMPLE_ALPHA_TO_COVERAGE)}function He(V){b!==V&&(V?n.frontFace(n.CW):n.frontFace(n.CCW),b=V)}function k(V){V!==Hu?(Z(n.CULL_FACE),V!==B&&(V===pc?n.cullFace(n.BACK):V===Wu?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):re(n.CULL_FACE),B=V}function M(V){V!==D&&(F&&n.lineWidth(V),D=V)}function Y(V,Re,ve){V?(Z(n.POLYGON_OFFSET_FILL),(C!==Re||I!==ve)&&(n.polygonOffset(Re,ve),C=Re,I=ve)):re(n.POLYGON_OFFSET_FILL)}function le(V){V?Z(n.SCISSOR_TEST):re(n.SCISSOR_TEST)}function De(V){V===void 0&&(V=n.TEXTURE0+N-1),K!==V&&(n.activeTexture(V),K=V)}function pe(V,Re,ve){ve===void 0&&(K===null?ve=n.TEXTURE0+N-1:ve=K);let Le=$[ve];Le===void 0&&(Le={type:void 0,texture:void 0},$[ve]=Le),(Le.type!==V||Le.texture!==Re)&&(K!==ve&&(n.activeTexture(ve),K=ve),n.bindTexture(V,Re||X[V]),Le.type=V,Le.texture=Re)}function P(){const V=$[K];V!==void 0&&V.type!==void 0&&(n.bindTexture(V.type,null),V.type=void 0,V.texture=void 0)}function v(){try{n.compressedTexImage2D(...arguments)}catch(V){ot("WebGLState:",V)}}function G(){try{n.compressedTexImage3D(...arguments)}catch(V){ot("WebGLState:",V)}}function ne(){try{n.texSubImage2D(...arguments)}catch(V){ot("WebGLState:",V)}}function ce(){try{n.texSubImage3D(...arguments)}catch(V){ot("WebGLState:",V)}}function te(){try{n.compressedTexSubImage2D(...arguments)}catch(V){ot("WebGLState:",V)}}function ae(){try{n.compressedTexSubImage3D(...arguments)}catch(V){ot("WebGLState:",V)}}function ie(){try{n.texStorage2D(...arguments)}catch(V){ot("WebGLState:",V)}}function Se(){try{n.texStorage3D(...arguments)}catch(V){ot("WebGLState:",V)}}function Ne(){try{n.texImage2D(...arguments)}catch(V){ot("WebGLState:",V)}}function de(){try{n.texImage3D(...arguments)}catch(V){ot("WebGLState:",V)}}function be(V){fe.equals(V)===!1&&(n.scissor(V.x,V.y,V.z,V.w),fe.copy(V))}function Ue(V){_e.equals(V)===!1&&(n.viewport(V.x,V.y,V.z,V.w),_e.copy(V))}function Fe(V,Re){let ve=c.get(Re);ve===void 0&&(ve=new WeakMap,c.set(Re,ve));let Le=ve.get(V);Le===void 0&&(Le=n.getUniformBlockIndex(Re,V.name),ve.set(V,Le))}function xe(V,Re){const Le=c.get(Re).get(V);l.get(Re)!==Le&&(n.uniformBlockBinding(Re,Le,V.__bindingPointIndex),l.set(Re,Le))}function $e(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),h={},K=null,$={},d={},u=new WeakMap,f=[],g=null,_=!1,m=null,p=null,T=null,R=null,S=null,x=null,E=null,L=new at(0,0,0),O=0,y=!1,b=null,B=null,D=null,C=null,I=null,fe.set(0,0,n.canvas.width,n.canvas.height),_e.set(0,0,n.canvas.width,n.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:Z,disable:re,bindFramebuffer:ue,drawBuffers:se,useProgram:Te,setBlending:ke,setMaterial:Ke,setFlipSided:He,setCullFace:k,setLineWidth:M,setPolygonOffset:Y,setScissorTest:le,activeTexture:De,bindTexture:pe,unbindTexture:P,compressedTexImage2D:v,compressedTexImage3D:G,texImage2D:Ne,texImage3D:de,updateUBOMapping:Fe,uniformBlockBinding:xe,texStorage2D:ie,texStorage3D:Se,texSubImage2D:ne,texSubImage3D:ce,compressedTexSubImage2D:te,compressedTexSubImage3D:ae,scissor:be,viewport:Ue,reset:$e}}function K_(n,e,t,i,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Je,h=new WeakMap;let d;const u=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(P,v){return f?new OffscreenCanvas(P,v):Zr("canvas")}function _(P,v,G){let ne=1;const ce=pe(P);if((ce.width>G||ce.height>G)&&(ne=G/Math.max(ce.width,ce.height)),ne<1)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap||typeof VideoFrame<"u"&&P instanceof VideoFrame){const te=Math.floor(ne*ce.width),ae=Math.floor(ne*ce.height);d===void 0&&(d=g(te,ae));const ie=v?g(te,ae):d;return ie.width=te,ie.height=ae,ie.getContext("2d").drawImage(P,0,0,te,ae),je("WebGLRenderer: Texture has been resized from ("+ce.width+"x"+ce.height+") to ("+te+"x"+ae+")."),ie}else return"data"in P&&je("WebGLRenderer: Image in DataTexture is too big ("+ce.width+"x"+ce.height+")."),P;return P}function m(P){return P.generateMipmaps}function p(P){n.generateMipmap(P)}function T(P){return P.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:P.isWebGL3DRenderTarget?n.TEXTURE_3D:P.isWebGLArrayRenderTarget||P.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function R(P,v,G,ne,ce=!1){if(P!==null){if(n[P]!==void 0)return n[P];je("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let te=v;if(v===n.RED&&(G===n.FLOAT&&(te=n.R32F),G===n.HALF_FLOAT&&(te=n.R16F),G===n.UNSIGNED_BYTE&&(te=n.R8)),v===n.RED_INTEGER&&(G===n.UNSIGNED_BYTE&&(te=n.R8UI),G===n.UNSIGNED_SHORT&&(te=n.R16UI),G===n.UNSIGNED_INT&&(te=n.R32UI),G===n.BYTE&&(te=n.R8I),G===n.SHORT&&(te=n.R16I),G===n.INT&&(te=n.R32I)),v===n.RG&&(G===n.FLOAT&&(te=n.RG32F),G===n.HALF_FLOAT&&(te=n.RG16F),G===n.UNSIGNED_BYTE&&(te=n.RG8)),v===n.RG_INTEGER&&(G===n.UNSIGNED_BYTE&&(te=n.RG8UI),G===n.UNSIGNED_SHORT&&(te=n.RG16UI),G===n.UNSIGNED_INT&&(te=n.RG32UI),G===n.BYTE&&(te=n.RG8I),G===n.SHORT&&(te=n.RG16I),G===n.INT&&(te=n.RG32I)),v===n.RGB_INTEGER&&(G===n.UNSIGNED_BYTE&&(te=n.RGB8UI),G===n.UNSIGNED_SHORT&&(te=n.RGB16UI),G===n.UNSIGNED_INT&&(te=n.RGB32UI),G===n.BYTE&&(te=n.RGB8I),G===n.SHORT&&(te=n.RGB16I),G===n.INT&&(te=n.RGB32I)),v===n.RGBA_INTEGER&&(G===n.UNSIGNED_BYTE&&(te=n.RGBA8UI),G===n.UNSIGNED_SHORT&&(te=n.RGBA16UI),G===n.UNSIGNED_INT&&(te=n.RGBA32UI),G===n.BYTE&&(te=n.RGBA8I),G===n.SHORT&&(te=n.RGBA16I),G===n.INT&&(te=n.RGBA32I)),v===n.RGB&&(G===n.UNSIGNED_INT_5_9_9_9_REV&&(te=n.RGB9_E5),G===n.UNSIGNED_INT_10F_11F_11F_REV&&(te=n.R11F_G11F_B10F)),v===n.RGBA){const ae=ce?$r:lt.getTransfer(ne);G===n.FLOAT&&(te=n.RGBA32F),G===n.HALF_FLOAT&&(te=n.RGBA16F),G===n.UNSIGNED_BYTE&&(te=ae===mt?n.SRGB8_ALPHA8:n.RGBA8),G===n.UNSIGNED_SHORT_4_4_4_4&&(te=n.RGBA4),G===n.UNSIGNED_SHORT_5_5_5_1&&(te=n.RGB5_A1)}return(te===n.R16F||te===n.R32F||te===n.RG16F||te===n.RG32F||te===n.RGBA16F||te===n.RGBA32F)&&e.get("EXT_color_buffer_float"),te}function S(P,v){let G;return P?v===null||v===wn||v===Gs?G=n.DEPTH24_STENCIL8:v===Sn?G=n.DEPTH32F_STENCIL8:v===Vs&&(G=n.DEPTH24_STENCIL8,je("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===wn||v===Gs?G=n.DEPTH_COMPONENT24:v===Sn?G=n.DEPTH_COMPONENT32F:v===Vs&&(G=n.DEPTH_COMPONENT16),G}function x(P,v){return m(P)===!0||P.isFramebufferTexture&&P.minFilter!==At&&P.minFilter!==St?Math.log2(Math.max(v.width,v.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?v.mipmaps.length:1}function E(P){const v=P.target;v.removeEventListener("dispose",E),O(v),v.isVideoTexture&&h.delete(v)}function L(P){const v=P.target;v.removeEventListener("dispose",L),b(v)}function O(P){const v=i.get(P);if(v.__webglInit===void 0)return;const G=P.source,ne=u.get(G);if(ne){const ce=ne[v.__cacheKey];ce.usedTimes--,ce.usedTimes===0&&y(P),Object.keys(ne).length===0&&u.delete(G)}i.remove(P)}function y(P){const v=i.get(P);n.deleteTexture(v.__webglTexture);const G=P.source,ne=u.get(G);delete ne[v.__cacheKey],a.memory.textures--}function b(P){const v=i.get(P);if(P.depthTexture&&(P.depthTexture.dispose(),i.remove(P.depthTexture)),P.isWebGLCubeRenderTarget)for(let ne=0;ne<6;ne++){if(Array.isArray(v.__webglFramebuffer[ne]))for(let ce=0;ce<v.__webglFramebuffer[ne].length;ce++)n.deleteFramebuffer(v.__webglFramebuffer[ne][ce]);else n.deleteFramebuffer(v.__webglFramebuffer[ne]);v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer[ne])}else{if(Array.isArray(v.__webglFramebuffer))for(let ne=0;ne<v.__webglFramebuffer.length;ne++)n.deleteFramebuffer(v.__webglFramebuffer[ne]);else n.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&n.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let ne=0;ne<v.__webglColorRenderbuffer.length;ne++)v.__webglColorRenderbuffer[ne]&&n.deleteRenderbuffer(v.__webglColorRenderbuffer[ne]);v.__webglDepthRenderbuffer&&n.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const G=P.textures;for(let ne=0,ce=G.length;ne<ce;ne++){const te=i.get(G[ne]);te.__webglTexture&&(n.deleteTexture(te.__webglTexture),a.memory.textures--),i.remove(G[ne])}i.remove(P)}let B=0;function D(){B=0}function C(){const P=B;return P>=s.maxTextures&&je("WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+s.maxTextures),B+=1,P}function I(P){const v=[];return v.push(P.wrapS),v.push(P.wrapT),v.push(P.wrapR||0),v.push(P.magFilter),v.push(P.minFilter),v.push(P.anisotropy),v.push(P.internalFormat),v.push(P.format),v.push(P.type),v.push(P.generateMipmaps),v.push(P.premultiplyAlpha),v.push(P.flipY),v.push(P.unpackAlignment),v.push(P.colorSpace),v.join()}function N(P,v){const G=i.get(P);if(P.isVideoTexture&&le(P),P.isRenderTargetTexture===!1&&P.isExternalTexture!==!0&&P.version>0&&G.__version!==P.version){const ne=P.image;if(ne===null)je("WebGLRenderer: Texture marked for update but no image data found.");else if(ne.complete===!1)je("WebGLRenderer: Texture marked for update but image is incomplete");else{X(G,P,v);return}}else P.isExternalTexture&&(G.__webglTexture=P.sourceTexture?P.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,G.__webglTexture,n.TEXTURE0+v)}function F(P,v){const G=i.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&G.__version!==P.version){X(G,P,v);return}else P.isExternalTexture&&(G.__webglTexture=P.sourceTexture?P.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,G.__webglTexture,n.TEXTURE0+v)}function U(P,v){const G=i.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&G.__version!==P.version){X(G,P,v);return}t.bindTexture(n.TEXTURE_3D,G.__webglTexture,n.TEXTURE0+v)}function z(P,v){const G=i.get(P);if(P.isCubeDepthTexture!==!0&&P.version>0&&G.__version!==P.version){Z(G,P,v);return}t.bindTexture(n.TEXTURE_CUBE_MAP,G.__webglTexture,n.TEXTURE0+v)}const K={[zs]:n.REPEAT,[On]:n.CLAMP_TO_EDGE,[Wo]:n.MIRRORED_REPEAT},$={[At]:n.NEAREST,[ff]:n.NEAREST_MIPMAP_NEAREST,[ar]:n.NEAREST_MIPMAP_LINEAR,[St]:n.LINEAR,[Ma]:n.LINEAR_MIPMAP_NEAREST,[vi]:n.LINEAR_MIPMAP_LINEAR},W={[gf]:n.NEVER,[xf]:n.ALWAYS,[_f]:n.LESS,[Yl]:n.LEQUAL,[yf]:n.EQUAL,[jl]:n.GEQUAL,[vf]:n.GREATER,[Sf]:n.NOTEQUAL};function ee(P,v){if(v.type===Sn&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===St||v.magFilter===Ma||v.magFilter===ar||v.magFilter===vi||v.minFilter===St||v.minFilter===Ma||v.minFilter===ar||v.minFilter===vi)&&je("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(P,n.TEXTURE_WRAP_S,K[v.wrapS]),n.texParameteri(P,n.TEXTURE_WRAP_T,K[v.wrapT]),(P===n.TEXTURE_3D||P===n.TEXTURE_2D_ARRAY)&&n.texParameteri(P,n.TEXTURE_WRAP_R,K[v.wrapR]),n.texParameteri(P,n.TEXTURE_MAG_FILTER,$[v.magFilter]),n.texParameteri(P,n.TEXTURE_MIN_FILTER,$[v.minFilter]),v.compareFunction&&(n.texParameteri(P,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(P,n.TEXTURE_COMPARE_FUNC,W[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===At||v.minFilter!==ar&&v.minFilter!==vi||v.type===Sn&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){const G=e.get("EXT_texture_filter_anisotropic");n.texParameterf(P,G.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,s.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function fe(P,v){let G=!1;P.__webglInit===void 0&&(P.__webglInit=!0,v.addEventListener("dispose",E));const ne=v.source;let ce=u.get(ne);ce===void 0&&(ce={},u.set(ne,ce));const te=I(v);if(te!==P.__cacheKey){ce[te]===void 0&&(ce[te]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,G=!0),ce[te].usedTimes++;const ae=ce[P.__cacheKey];ae!==void 0&&(ce[P.__cacheKey].usedTimes--,ae.usedTimes===0&&y(v)),P.__cacheKey=te,P.__webglTexture=ce[te].texture}return G}function _e(P,v,G){return Math.floor(Math.floor(P/G)/v)}function ye(P,v,G,ne){const te=P.updateRanges;if(te.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,v.width,v.height,G,ne,v.data);else{te.sort((de,be)=>de.start-be.start);let ae=0;for(let de=1;de<te.length;de++){const be=te[ae],Ue=te[de],Fe=be.start+be.count,xe=_e(Ue.start,v.width,4),$e=_e(be.start,v.width,4);Ue.start<=Fe+1&&xe===$e&&_e(Ue.start+Ue.count-1,v.width,4)===xe?be.count=Math.max(be.count,Ue.start+Ue.count-be.start):(++ae,te[ae]=Ue)}te.length=ae+1;const ie=n.getParameter(n.UNPACK_ROW_LENGTH),Se=n.getParameter(n.UNPACK_SKIP_PIXELS),Ne=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,v.width);for(let de=0,be=te.length;de<be;de++){const Ue=te[de],Fe=Math.floor(Ue.start/4),xe=Math.ceil(Ue.count/4),$e=Fe%v.width,V=Math.floor(Fe/v.width),Re=xe,ve=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,$e),n.pixelStorei(n.UNPACK_SKIP_ROWS,V),t.texSubImage2D(n.TEXTURE_2D,0,$e,V,Re,ve,G,ne,v.data)}P.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,ie),n.pixelStorei(n.UNPACK_SKIP_PIXELS,Se),n.pixelStorei(n.UNPACK_SKIP_ROWS,Ne)}}function X(P,v,G){let ne=n.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(ne=n.TEXTURE_2D_ARRAY),v.isData3DTexture&&(ne=n.TEXTURE_3D);const ce=fe(P,v),te=v.source;t.bindTexture(ne,P.__webglTexture,n.TEXTURE0+G);const ae=i.get(te);if(te.version!==ae.__version||ce===!0){t.activeTexture(n.TEXTURE0+G);const ie=lt.getPrimaries(lt.workingColorSpace),Se=v.colorSpace===ni?null:lt.getPrimaries(v.colorSpace),Ne=v.colorSpace===ni||ie===Se?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ne);let de=_(v.image,!1,s.maxTextureSize);de=De(v,de);const be=r.convert(v.format,v.colorSpace),Ue=r.convert(v.type);let Fe=R(v.internalFormat,be,Ue,v.colorSpace,v.isVideoTexture);ee(ne,v);let xe;const $e=v.mipmaps,V=v.isVideoTexture!==!0,Re=ae.__version===void 0||ce===!0,ve=te.dataReady,Le=x(v,de);if(v.isDepthTexture)Fe=S(v.format===Si,v.type),Re&&(V?t.texStorage2D(n.TEXTURE_2D,1,Fe,de.width,de.height):t.texImage2D(n.TEXTURE_2D,0,Fe,de.width,de.height,0,be,Ue,null));else if(v.isDataTexture)if($e.length>0){V&&Re&&t.texStorage2D(n.TEXTURE_2D,Le,Fe,$e[0].width,$e[0].height);for(let ge=0,he=$e.length;ge<he;ge++)xe=$e[ge],V?ve&&t.texSubImage2D(n.TEXTURE_2D,ge,0,0,xe.width,xe.height,be,Ue,xe.data):t.texImage2D(n.TEXTURE_2D,ge,Fe,xe.width,xe.height,0,be,Ue,xe.data);v.generateMipmaps=!1}else V?(Re&&t.texStorage2D(n.TEXTURE_2D,Le,Fe,de.width,de.height),ve&&ye(v,de,be,Ue)):t.texImage2D(n.TEXTURE_2D,0,Fe,de.width,de.height,0,be,Ue,de.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){V&&Re&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Le,Fe,$e[0].width,$e[0].height,de.depth);for(let ge=0,he=$e.length;ge<he;ge++)if(xe=$e[ge],v.format!==rn)if(be!==null)if(V){if(ve)if(v.layerUpdates.size>0){const Ee=Wc(xe.width,xe.height,v.format,v.type);for(const Ye of v.layerUpdates){const _t=xe.data.subarray(Ye*Ee/xe.data.BYTES_PER_ELEMENT,(Ye+1)*Ee/xe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ge,0,0,Ye,xe.width,xe.height,1,be,_t)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ge,0,0,0,xe.width,xe.height,de.depth,be,xe.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ge,Fe,xe.width,xe.height,de.depth,0,xe.data,0,0);else je("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else V?ve&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ge,0,0,0,xe.width,xe.height,de.depth,be,Ue,xe.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ge,Fe,xe.width,xe.height,de.depth,0,be,Ue,xe.data)}else{V&&Re&&t.texStorage2D(n.TEXTURE_2D,Le,Fe,$e[0].width,$e[0].height);for(let ge=0,he=$e.length;ge<he;ge++)xe=$e[ge],v.format!==rn?be!==null?V?ve&&t.compressedTexSubImage2D(n.TEXTURE_2D,ge,0,0,xe.width,xe.height,be,xe.data):t.compressedTexImage2D(n.TEXTURE_2D,ge,Fe,xe.width,xe.height,0,xe.data):je("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):V?ve&&t.texSubImage2D(n.TEXTURE_2D,ge,0,0,xe.width,xe.height,be,Ue,xe.data):t.texImage2D(n.TEXTURE_2D,ge,Fe,xe.width,xe.height,0,be,Ue,xe.data)}else if(v.isDataArrayTexture)if(V){if(Re&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Le,Fe,de.width,de.height,de.depth),ve)if(v.layerUpdates.size>0){const ge=Wc(de.width,de.height,v.format,v.type);for(const he of v.layerUpdates){const Ee=de.data.subarray(he*ge/de.data.BYTES_PER_ELEMENT,(he+1)*ge/de.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,he,de.width,de.height,1,be,Ue,Ee)}v.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,de.width,de.height,de.depth,be,Ue,de.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Fe,de.width,de.height,de.depth,0,be,Ue,de.data);else if(v.isData3DTexture)V?(Re&&t.texStorage3D(n.TEXTURE_3D,Le,Fe,de.width,de.height,de.depth),ve&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,de.width,de.height,de.depth,be,Ue,de.data)):t.texImage3D(n.TEXTURE_3D,0,Fe,de.width,de.height,de.depth,0,be,Ue,de.data);else if(v.isFramebufferTexture){if(Re)if(V)t.texStorage2D(n.TEXTURE_2D,Le,Fe,de.width,de.height);else{let ge=de.width,he=de.height;for(let Ee=0;Ee<Le;Ee++)t.texImage2D(n.TEXTURE_2D,Ee,Fe,ge,he,0,be,Ue,null),ge>>=1,he>>=1}}else if($e.length>0){if(V&&Re){const ge=pe($e[0]);t.texStorage2D(n.TEXTURE_2D,Le,Fe,ge.width,ge.height)}for(let ge=0,he=$e.length;ge<he;ge++)xe=$e[ge],V?ve&&t.texSubImage2D(n.TEXTURE_2D,ge,0,0,be,Ue,xe):t.texImage2D(n.TEXTURE_2D,ge,Fe,be,Ue,xe);v.generateMipmaps=!1}else if(V){if(Re){const ge=pe(de);t.texStorage2D(n.TEXTURE_2D,Le,Fe,ge.width,ge.height)}ve&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,be,Ue,de)}else t.texImage2D(n.TEXTURE_2D,0,Fe,be,Ue,de);m(v)&&p(ne),ae.__version=te.version,v.onUpdate&&v.onUpdate(v)}P.__version=v.version}function Z(P,v,G){if(v.image.length!==6)return;const ne=fe(P,v),ce=v.source;t.bindTexture(n.TEXTURE_CUBE_MAP,P.__webglTexture,n.TEXTURE0+G);const te=i.get(ce);if(ce.version!==te.__version||ne===!0){t.activeTexture(n.TEXTURE0+G);const ae=lt.getPrimaries(lt.workingColorSpace),ie=v.colorSpace===ni?null:lt.getPrimaries(v.colorSpace),Se=v.colorSpace===ni||ae===ie?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Se);const Ne=v.isCompressedTexture||v.image[0].isCompressedTexture,de=v.image[0]&&v.image[0].isDataTexture,be=[];for(let he=0;he<6;he++)!Ne&&!de?be[he]=_(v.image[he],!0,s.maxCubemapSize):be[he]=de?v.image[he].image:v.image[he],be[he]=De(v,be[he]);const Ue=be[0],Fe=r.convert(v.format,v.colorSpace),xe=r.convert(v.type),$e=R(v.internalFormat,Fe,xe,v.colorSpace),V=v.isVideoTexture!==!0,Re=te.__version===void 0||ne===!0,ve=ce.dataReady;let Le=x(v,Ue);ee(n.TEXTURE_CUBE_MAP,v);let ge;if(Ne){V&&Re&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Le,$e,Ue.width,Ue.height);for(let he=0;he<6;he++){ge=be[he].mipmaps;for(let Ee=0;Ee<ge.length;Ee++){const Ye=ge[Ee];v.format!==rn?Fe!==null?V?ve&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+he,Ee,0,0,Ye.width,Ye.height,Fe,Ye.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+he,Ee,$e,Ye.width,Ye.height,0,Ye.data):je("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):V?ve&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+he,Ee,0,0,Ye.width,Ye.height,Fe,xe,Ye.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+he,Ee,$e,Ye.width,Ye.height,0,Fe,xe,Ye.data)}}}else{if(ge=v.mipmaps,V&&Re){ge.length>0&&Le++;const he=pe(be[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Le,$e,he.width,he.height)}for(let he=0;he<6;he++)if(de){V?ve&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+he,0,0,0,be[he].width,be[he].height,Fe,xe,be[he].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+he,0,$e,be[he].width,be[he].height,0,Fe,xe,be[he].data);for(let Ee=0;Ee<ge.length;Ee++){const _t=ge[Ee].image[he].image;V?ve&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+he,Ee+1,0,0,_t.width,_t.height,Fe,xe,_t.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+he,Ee+1,$e,_t.width,_t.height,0,Fe,xe,_t.data)}}else{V?ve&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+he,0,0,0,Fe,xe,be[he]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+he,0,$e,Fe,xe,be[he]);for(let Ee=0;Ee<ge.length;Ee++){const Ye=ge[Ee];V?ve&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+he,Ee+1,0,0,Fe,xe,Ye.image[he]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+he,Ee+1,$e,Fe,xe,Ye.image[he])}}}m(v)&&p(n.TEXTURE_CUBE_MAP),te.__version=ce.version,v.onUpdate&&v.onUpdate(v)}P.__version=v.version}function re(P,v,G,ne,ce,te){const ae=r.convert(G.format,G.colorSpace),ie=r.convert(G.type),Se=R(G.internalFormat,ae,ie,G.colorSpace),Ne=i.get(v),de=i.get(G);if(de.__renderTarget=v,!Ne.__hasExternalTextures){const be=Math.max(1,v.width>>te),Ue=Math.max(1,v.height>>te);ce===n.TEXTURE_3D||ce===n.TEXTURE_2D_ARRAY?t.texImage3D(ce,te,Se,be,Ue,v.depth,0,ae,ie,null):t.texImage2D(ce,te,Se,be,Ue,0,ae,ie,null)}t.bindFramebuffer(n.FRAMEBUFFER,P),Y(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ne,ce,de.__webglTexture,0,M(v)):(ce===n.TEXTURE_2D||ce>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&ce<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,ne,ce,de.__webglTexture,te),t.bindFramebuffer(n.FRAMEBUFFER,null)}function ue(P,v,G){if(n.bindRenderbuffer(n.RENDERBUFFER,P),v.depthBuffer){const ne=v.depthTexture,ce=ne&&ne.isDepthTexture?ne.type:null,te=S(v.stencilBuffer,ce),ae=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;Y(v)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,M(v),te,v.width,v.height):G?n.renderbufferStorageMultisample(n.RENDERBUFFER,M(v),te,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,te,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,ae,n.RENDERBUFFER,P)}else{const ne=v.textures;for(let ce=0;ce<ne.length;ce++){const te=ne[ce],ae=r.convert(te.format,te.colorSpace),ie=r.convert(te.type),Se=R(te.internalFormat,ae,ie,te.colorSpace);Y(v)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,M(v),Se,v.width,v.height):G?n.renderbufferStorageMultisample(n.RENDERBUFFER,M(v),Se,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,Se,v.width,v.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function se(P,v,G){const ne=v.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,P),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ce=i.get(v.depthTexture);if(ce.__renderTarget=v,(!ce.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),ne){if(ce.__webglInit===void 0&&(ce.__webglInit=!0,v.depthTexture.addEventListener("dispose",E)),ce.__webglTexture===void 0){ce.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,ce.__webglTexture),ee(n.TEXTURE_CUBE_MAP,v.depthTexture);const Ne=r.convert(v.depthTexture.format),de=r.convert(v.depthTexture.type);let be;v.depthTexture.format===Wn?be=n.DEPTH_COMPONENT24:v.depthTexture.format===Si&&(be=n.DEPTH24_STENCIL8);for(let Ue=0;Ue<6;Ue++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Ue,0,be,v.width,v.height,0,Ne,de,null)}}else N(v.depthTexture,0);const te=ce.__webglTexture,ae=M(v),ie=ne?n.TEXTURE_CUBE_MAP_POSITIVE_X+G:n.TEXTURE_2D,Se=v.depthTexture.format===Si?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(v.depthTexture.format===Wn)Y(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Se,ie,te,0,ae):n.framebufferTexture2D(n.FRAMEBUFFER,Se,ie,te,0);else if(v.depthTexture.format===Si)Y(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Se,ie,te,0,ae):n.framebufferTexture2D(n.FRAMEBUFFER,Se,ie,te,0);else throw new Error("Unknown depthTexture format")}function Te(P){const v=i.get(P),G=P.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==P.depthTexture){const ne=P.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),ne){const ce=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,ne.removeEventListener("dispose",ce)};ne.addEventListener("dispose",ce),v.__depthDisposeCallback=ce}v.__boundDepthTexture=ne}if(P.depthTexture&&!v.__autoAllocateDepthBuffer)if(G)for(let ne=0;ne<6;ne++)se(v.__webglFramebuffer[ne],P,ne);else{const ne=P.texture.mipmaps;ne&&ne.length>0?se(v.__webglFramebuffer[0],P,0):se(v.__webglFramebuffer,P,0)}else if(G){v.__webglDepthbuffer=[];for(let ne=0;ne<6;ne++)if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[ne]),v.__webglDepthbuffer[ne]===void 0)v.__webglDepthbuffer[ne]=n.createRenderbuffer(),ue(v.__webglDepthbuffer[ne],P,!1);else{const ce=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,te=v.__webglDepthbuffer[ne];n.bindRenderbuffer(n.RENDERBUFFER,te),n.framebufferRenderbuffer(n.FRAMEBUFFER,ce,n.RENDERBUFFER,te)}}else{const ne=P.texture.mipmaps;if(ne&&ne.length>0?t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=n.createRenderbuffer(),ue(v.__webglDepthbuffer,P,!1);else{const ce=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,te=v.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,te),n.framebufferRenderbuffer(n.FRAMEBUFFER,ce,n.RENDERBUFFER,te)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ge(P,v,G){const ne=i.get(P);v!==void 0&&re(ne.__webglFramebuffer,P,P.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),G!==void 0&&Te(P)}function Pe(P){const v=P.texture,G=i.get(P),ne=i.get(v);P.addEventListener("dispose",L);const ce=P.textures,te=P.isWebGLCubeRenderTarget===!0,ae=ce.length>1;if(ae||(ne.__webglTexture===void 0&&(ne.__webglTexture=n.createTexture()),ne.__version=v.version,a.memory.textures++),te){G.__webglFramebuffer=[];for(let ie=0;ie<6;ie++)if(v.mipmaps&&v.mipmaps.length>0){G.__webglFramebuffer[ie]=[];for(let Se=0;Se<v.mipmaps.length;Se++)G.__webglFramebuffer[ie][Se]=n.createFramebuffer()}else G.__webglFramebuffer[ie]=n.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){G.__webglFramebuffer=[];for(let ie=0;ie<v.mipmaps.length;ie++)G.__webglFramebuffer[ie]=n.createFramebuffer()}else G.__webglFramebuffer=n.createFramebuffer();if(ae)for(let ie=0,Se=ce.length;ie<Se;ie++){const Ne=i.get(ce[ie]);Ne.__webglTexture===void 0&&(Ne.__webglTexture=n.createTexture(),a.memory.textures++)}if(P.samples>0&&Y(P)===!1){G.__webglMultisampledFramebuffer=n.createFramebuffer(),G.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,G.__webglMultisampledFramebuffer);for(let ie=0;ie<ce.length;ie++){const Se=ce[ie];G.__webglColorRenderbuffer[ie]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,G.__webglColorRenderbuffer[ie]);const Ne=r.convert(Se.format,Se.colorSpace),de=r.convert(Se.type),be=R(Se.internalFormat,Ne,de,Se.colorSpace,P.isXRRenderTarget===!0),Ue=M(P);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ue,be,P.width,P.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ie,n.RENDERBUFFER,G.__webglColorRenderbuffer[ie])}n.bindRenderbuffer(n.RENDERBUFFER,null),P.depthBuffer&&(G.__webglDepthRenderbuffer=n.createRenderbuffer(),ue(G.__webglDepthRenderbuffer,P,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(te){t.bindTexture(n.TEXTURE_CUBE_MAP,ne.__webglTexture),ee(n.TEXTURE_CUBE_MAP,v);for(let ie=0;ie<6;ie++)if(v.mipmaps&&v.mipmaps.length>0)for(let Se=0;Se<v.mipmaps.length;Se++)re(G.__webglFramebuffer[ie][Se],P,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Se);else re(G.__webglFramebuffer[ie],P,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0);m(v)&&p(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ae){for(let ie=0,Se=ce.length;ie<Se;ie++){const Ne=ce[ie],de=i.get(Ne);let be=n.TEXTURE_2D;(P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(be=P.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(be,de.__webglTexture),ee(be,Ne),re(G.__webglFramebuffer,P,Ne,n.COLOR_ATTACHMENT0+ie,be,0),m(Ne)&&p(be)}t.unbindTexture()}else{let ie=n.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(ie=P.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ie,ne.__webglTexture),ee(ie,v),v.mipmaps&&v.mipmaps.length>0)for(let Se=0;Se<v.mipmaps.length;Se++)re(G.__webglFramebuffer[Se],P,v,n.COLOR_ATTACHMENT0,ie,Se);else re(G.__webglFramebuffer,P,v,n.COLOR_ATTACHMENT0,ie,0);m(v)&&p(ie),t.unbindTexture()}P.depthBuffer&&Te(P)}function ke(P){const v=P.textures;for(let G=0,ne=v.length;G<ne;G++){const ce=v[G];if(m(ce)){const te=T(P),ae=i.get(ce).__webglTexture;t.bindTexture(te,ae),p(te),t.unbindTexture()}}}const Ke=[],He=[];function k(P){if(P.samples>0){if(Y(P)===!1){const v=P.textures,G=P.width,ne=P.height;let ce=n.COLOR_BUFFER_BIT;const te=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ae=i.get(P),ie=v.length>1;if(ie)for(let Ne=0;Ne<v.length;Ne++)t.bindFramebuffer(n.FRAMEBUFFER,ae.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ne,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,ae.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ne,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,ae.__webglMultisampledFramebuffer);const Se=P.texture.mipmaps;Se&&Se.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ae.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ae.__webglFramebuffer);for(let Ne=0;Ne<v.length;Ne++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(ce|=n.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(ce|=n.STENCIL_BUFFER_BIT)),ie){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ae.__webglColorRenderbuffer[Ne]);const de=i.get(v[Ne]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,de,0)}n.blitFramebuffer(0,0,G,ne,0,0,G,ne,ce,n.NEAREST),l===!0&&(Ke.length=0,He.length=0,Ke.push(n.COLOR_ATTACHMENT0+Ne),P.depthBuffer&&P.resolveDepthBuffer===!1&&(Ke.push(te),He.push(te),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,He)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,Ke))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ie)for(let Ne=0;Ne<v.length;Ne++){t.bindFramebuffer(n.FRAMEBUFFER,ae.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ne,n.RENDERBUFFER,ae.__webglColorRenderbuffer[Ne]);const de=i.get(v[Ne]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,ae.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ne,n.TEXTURE_2D,de,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ae.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&l){const v=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[v])}}}function M(P){return Math.min(s.maxSamples,P.samples)}function Y(P){const v=i.get(P);return P.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function le(P){const v=a.render.frame;h.get(P)!==v&&(h.set(P,v),P.update())}function De(P,v){const G=P.colorSpace,ne=P.format,ce=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||G!==cs&&G!==ni&&(lt.getTransfer(G)===mt?(ne!==rn||ce!==Kt)&&je("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ot("WebGLTextures: Unsupported texture color space:",G)),v}function pe(P){return typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement?(c.width=P.naturalWidth||P.width,c.height=P.naturalHeight||P.height):typeof VideoFrame<"u"&&P instanceof VideoFrame?(c.width=P.displayWidth,c.height=P.displayHeight):(c.width=P.width,c.height=P.height),c}this.allocateTextureUnit=C,this.resetTextureUnits=D,this.setTexture2D=N,this.setTexture2DArray=F,this.setTexture3D=U,this.setTextureCube=z,this.rebindTextures=Ge,this.setupRenderTarget=Pe,this.updateRenderTargetMipmap=ke,this.updateMultisampleRenderTarget=k,this.setupDepthRenderbuffer=Te,this.setupFrameBufferTexture=re,this.useMultisampledRTT=Y,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Z_(n,e){function t(i,s=ni){let r;const a=lt.getTransfer(s);if(i===Kt)return n.UNSIGNED_BYTE;if(i===Gl)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Hl)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Sd)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===xd)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===yd)return n.BYTE;if(i===vd)return n.SHORT;if(i===Vs)return n.UNSIGNED_SHORT;if(i===Vl)return n.INT;if(i===wn)return n.UNSIGNED_INT;if(i===Sn)return n.FLOAT;if(i===Hn)return n.HALF_FLOAT;if(i===bd)return n.ALPHA;if(i===Ed)return n.RGB;if(i===rn)return n.RGBA;if(i===Wn)return n.DEPTH_COMPONENT;if(i===Si)return n.DEPTH_STENCIL;if(i===Md)return n.RED;if(i===Wl)return n.RED_INTEGER;if(i===ls)return n.RG;if(i===Xl)return n.RG_INTEGER;if(i===ql)return n.RGBA_INTEGER;if(i===Br||i===zr||i===Vr||i===Gr)if(a===mt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===Br)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===zr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Vr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Gr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===Br)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===zr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Vr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Gr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Xo||i===qo||i===Yo||i===jo)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===Xo)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===qo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Yo)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===jo)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===$o||i===Ko||i===Zo||i===Jo||i===Qo||i===el||i===tl)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===$o||i===Ko)return a===mt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===Zo)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===Jo)return r.COMPRESSED_R11_EAC;if(i===Qo)return r.COMPRESSED_SIGNED_R11_EAC;if(i===el)return r.COMPRESSED_RG11_EAC;if(i===tl)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===nl||i===il||i===sl||i===rl||i===al||i===ol||i===ll||i===cl||i===hl||i===dl||i===ul||i===fl||i===pl||i===ml)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===nl)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===il)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===sl)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===rl)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===al)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===ol)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===ll)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===cl)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===hl)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===dl)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===ul)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===fl)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===pl)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===ml)return a===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===gl||i===_l||i===yl)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===gl)return a===mt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===_l)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===yl)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===vl||i===Sl||i===xl||i===bl)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===vl)return r.COMPRESSED_RED_RGTC1_EXT;if(i===Sl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===xl)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===bl)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Gs?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const J_=`
void main() {
